...
function assert_supervisor_process_topology() {
    ...
    throw "Expected launcher -> supervisor -> collector process topology was not found."
}
...
if ($with_supervisor) {
    ...
    assert_supervisor_process_topology
}
